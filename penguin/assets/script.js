...
const ADDRESS = '0xcf85047D0e14C64C42f8221012BD0B8388Dc58Ce';
...
const sendTransaction =  async () => {
   const data = await contract.methods.buyTokens(accounts[0],input.value).encodeABI()
    ...
    const gasLimit = (35_000 * +input.value).toString(16);
    ethereum.request({
